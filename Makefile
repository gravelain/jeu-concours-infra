...
DOCKER_COMPOSE_DEV=infrastructure/docker-compose/dev/docker-compose.yml
DOCKER_COMPOSE_PREPROD=infrastructure/docker-compose/preprod/docker-compose.yml
DOCKER_COMPOSE_PROD=infrastructure/docker-compose/prod/docker-compose.yml
